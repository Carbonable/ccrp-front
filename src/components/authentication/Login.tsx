...
const LoginForm: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="uppercase text-lg font-light">Sign in</div>
      ...
      {error && (
        <div className="bg-red-500 mt-4 py-2 rounded-lg text-sm text-neutral-50 relative">
          {error}
          <div
            className="absolute right-2 top-1 text-xs cursor-pointer"
            onClick={closeError}
          >
            x
          </div>
      ...
      <div className="mt-8 w-full">
        <PrimaryButton type="submit" isLoading={isLogin} className="w-full">
          Login
        </PrimaryButton>
      </div>
    </form>
