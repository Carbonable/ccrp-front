...
export default function Menu({openMenu, setOpenMenu}: {openMenu: boolean, setOpenMenu: (open: boolean) => void}) {
    ...
    return (
        <div className={`${openMenu ? "block w-[300px] z-50 fixed bg-neutral-900 " : "hidden w-0 bg-neutral-900" } left-0 lg:w-[222px] h-[calc(100vh_-_68px)] lg:h-[100vh] lg:block lg:fixed lg:bg-neutral-900/80 pt-4 pr-4 `}>
